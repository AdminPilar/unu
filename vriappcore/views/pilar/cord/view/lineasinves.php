...
<div>
	<p>El listado de líneas de Investigación registradas con sus respectivos docentes especialistas</p>
	...
	<?php
		...
		foreach($lineas->result() as $row){
			...
			if($count>=0){ //se muestra las lineas que solo tienen mas de 4 docentes activos -unuv1.0
	 ?>
